				...
				<div className='level'>
					<div className='level-item'>
						<p className='body-of-text'>
							I am a software developer out of Boston, MA who loves to 
							create value for others. My goal is to make your dreams and concepts a reality.
							Take a poke around my site to learn more! 
						</p>
					</div>
				</div>
			</div>
